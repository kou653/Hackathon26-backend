<div>
    ...
    <div class="flex py-2 px-4 ">
        ...
        <div class="pt-5 w-32 ml-3 px-2 py-2  ">
            <select wire:model='niveauselect' class="relative w-full px-4 py-2 text-sm text-gray-600 placeholder-gray-400 bg-white border-gray-400 rounded outline-none form-select focus:border-coolGray-400 focus:outline-none focus:ring-coolGray-100">
        ...
        <form method="POST">
            ...
            <button wire:click.prevent="resetSelection()" class="px-4 py-2 mt-5 mr-1 text-sm font-bold uppercase border rounded-md cursor-pointer bg-red-600 text-white hshadow">
                Reset
            </button>
        </form>
        @endif
                            ...
                            <tr>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-bold  flex text-gray-900 text-md">
                                                ...
                                                <form action="{{route('selection.sendmail', null, false)}}" method="POST">
                                                    @csrf
                                                    <input type="text" name="id" value="{{$equipe->id}}" hidden>
                                                    <button type="submit" class="px-2 py-1 mx-4 text-sm font-bold flex text-orange uppercase transition-all duration-150 rounded shadow outline-none ease-linearbg-emerald-500  hover:shadow-lg focus:outline-none" type="submit">
                                ...
                                <td>
                                    <div class="flex">
                                        ...
                                        @if($equipe->statut == true)
                                        <button wire:click.prevent='selection({{$equipe->id}})' class="px-2 py-1 text-sm font-bold flex text-red-700 uppercase transition-all duration-150 rounded shadow outline-none ease-linearbg-emerald-500  hover:shadow-lg focus:outline-none" type="submit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <button wire:click.prevent='selection({{$equipe->id}})' class="px-2 py-1 text-sm font-bold flex text-green-700 uppercase transition-all duration-150 rounded shadow outline-none ease-linearbg-emerald-500  hover:shadow-lg focus:outline-none" type="submit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                                            </svg>
                                        </button>
